...
<script>
    ...
    import ASearch from '~/components/Sections/Search.vue'

    export default {
        components: { AButton, AHamburger, ANavbar, ASearch },
        data() {
            return {
                isExpanded: false,
            }
