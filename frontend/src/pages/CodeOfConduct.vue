  ...
  <Layout>
    ...
    <a-article>
      <template v-slot:hero>
        ...
        <h3 class="lede">
          The Internet is a challenging place to foster a great culture, so we have to be intentional about it. We should continously strive to become an inclusive and a welcoming community.
        </h3>
      </template>
      ...
      <p>
        Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting <a href="mailto:nguyenpl117@gmail.com">[Trung Nguyên]</a>. All complaints will be reviewed and investigated and will result in a response that is deemed necessary and appropriate to the circumstances. The project team is obligated to maintain confidentiality with regard to the reporter of an incident. Further details of specific enforcement policies may be posted separately.
      </p>
