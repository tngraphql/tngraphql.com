  ...
  <section class="hero">
    <div class="container">
      <div class="hero-container">
        ...
        <div class="cta">
          <!-- @hardcoded -->
          <a-button title="Bắt đầu" href="/guides/quick-start" />
          <a-button title="Source code" href="https://github.com/tngraphql" class="secondary source-code-btn">
